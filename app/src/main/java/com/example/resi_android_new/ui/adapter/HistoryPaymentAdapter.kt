...
class HistoryPaymentAdapter(private val historyPayment : List<GetPreviewHistoryPayment>) : RecyclerView.Adapter<HistoryPaymentAdapter.ViewHolder>(){
    class ViewHolder(val  binding: ItemHistoryBinding) : RecyclerView.ViewHolder(binding.root){
        fun bind(item : GetPreviewHistoryPayment){
