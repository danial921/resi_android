 ...
 * Use the [FragmentKebijakanPrivasi.newInstance] factory method to
...
class FragmentKebijakanPrivasi : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentKebijakanPrivasi.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FragmentKebijakanPrivasi().apply {
